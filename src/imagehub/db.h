...
#define IMAGEHUB_SCHEMA_VERSION 1
#define IMAGEHUB_DB_HEARTBEAT_INTERVAL 60000
...
class DbHeartbeat : public QObject
{
  Q_OBJECT;
 public:
  DbHeartbeat(QObject *parent=0,int interval=IMAGEHUB_DB_HEARTBEAT_INTERVAL);
  ~DbHeartbeat();
